...
Les résultats sont repris aux figures \ref{ergo_cste_STD}, \ref{ergo_lineaire_STD}, \ref{ergo_anti_STD} et \ref{ergo_vague_STD}.
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.35]{Figures/Homogene/crop_STDvsTau_lineaire.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.35]{Figures/Homogene/crop_STDvsTau_anti.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.35]{Figures/Homogene/crop_STDvsTau_vague.pdf}
